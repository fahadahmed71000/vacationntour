...
const Page = () => {
  ...
  useEffect(() => {
    gsap.fromTo(boxRef.current, { opacity: 0, y: -50 }, { opacity: 1, y: 0, duration: 2});
  }, []);

  const mainRef = useRef(null);
  useEffect(() => {
    gsap.fromTo(mainRef.current, { opacity: 2, x: -150 }, { opacity: 1, x: 0, duration: 2});
  }, []);

  const imgRef = useRef(null);
  useEffect(() => {
    gsap.fromTo(imgRef.current, { opacity: 2, x: 150 }, { opacity: 1, x: 0, duration: 2});
  }, []);
  ...
  return (
    <div className="w-full max-w-screen overflow-x-hidden flex flex-col items-center justify-center z-10">
      {/* Navbar */}
      <div ref={boxRef} className="navbar flex justify-between lg:justify-around w-full px-4 lg:px-10 pt-5 lg:pt-10 relative z-0 ">
        <div className="logo">
      ...
      {/* Sidebar */}
      <div
        className={`lg:hidden fixed top-0 left-0 w-64 h-full bg-gray-700 text-white shadow-lg z-20 transform ${
      ...
      <div className="w-full flex flex-col lg:flex-row mt-10 lg:mt-20 px-4 md:px-8 lg:px-20 xl:px-40">
        <div ref={mainRef}  className="w-full lg:w-1/2">
          <div className="mt-10 lg:mt-20">
            ...
            <h1 className="text-[#181E4B] font-bold text-3xl lg:text-5xl pt-5">
              Travel, <span className="border-b-4 border-red-400">enjoy</span> and live a new and full life
            </h1>
            ...
            <div className="pt-5 flex items-center space-x-4">
             ...
             <div className="pt-6"><img src={Playbutton} alt="Play Demo" className="h-16 lg:h-32" /></div> 
        ...
        <div ref={imgRef}  className="w-full lg:w-1/2 mt-10 lg:mt-0">
          <div className="relative w-full">
            ...
            <div className="absolute top-2 left-28 h-14">
